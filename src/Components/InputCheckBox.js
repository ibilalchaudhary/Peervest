          ...
          return (
            <>
              <input
                ...
                name={
                  "start__up__container__form__input__box__check__box__label" +
                  placeholder
                }
                id={
                  "start__up__container__form__input__box__check__box__label" +
                ...
                className="start__up__container__form__input__box__check__box__input"
              />
              <label
                htmlFor={
                  "start__up__container__form__input__box__check__box__label" +
                ...
                className="start__up__container__form__input__box__check__box__label"
                // style={
                //   item.label === "Other:"
                //     ? {
                //         display: "flex",
